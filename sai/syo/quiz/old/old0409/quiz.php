...
<div id="div1">
  <h1>3択クイズ！</h1>
	<dl>
		<dt><?php echo h($member['user_name']); ?>さん、メッセージをどうぞ</dt>
	</dl>
</div>
...
<p>
	...
	echo h(($_SESSION['genre'])).'<br>';
		...
		/*
		$_SESSION['quiz']['answer'];
		$_SESSION['quiz']['choice_a'];
		$_SESSION['quiz']['choice_b'];
		$_SESSION['quiz']['choice_c'];
		
		echo h(($quiz['question'])).'<br>';
		echo h(($quiz['answer'])).'<br>';
		echo h(($quiz['choice_a'])).'<br>';
		echo h(($quiz['choice_b'])).'<br>';
		echo h(($quiz['choice_c'])).'<br>';
		*/
	}
	?>
</p>
