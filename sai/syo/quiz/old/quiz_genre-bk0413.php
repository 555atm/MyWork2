...
<label><input type="checkbox" name="all_genre" value="全部" checked>全ジャンル</label><br>
<label><input type="checkbox" name="足し算" value="足し算">足し算</label><br>
<label><input type="checkbox" name="引き算" value="引き算">引き算</label><br>
...
<form action="./quiz/quiz.php" method="post">
  ...
  <input type="submit" value="3択クイズゲームへ">
</form>
</div>
