...
<div class="random">
  ...
  <?php 
    ...
    while ($allquiz = $stmt->fetch()){
      ...
      $_SESSION['syutsudai_random'][] = $allquiz['id'];
    }
    print_r($_SESSION['syutsudai_random']);
    print_r($_SESSION['syutsudai']);
  ?>

  <form action="quiz.php" method="post">
    <input type="hidden" name="syutsudai[]" value="<?php $_SESSION['syutsudai'] = $_SESSION['syutsudai_random']; ?>" id=""> 
    <input type="submit" value="3択クイズゲーム開始！">    
  </form>
